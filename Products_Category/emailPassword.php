...
// subject
$titulo = 'Nueva contraseña del cliente de Hand Market app';

// message
$mensaje = ("
<font size='3'> Hola, $nomUsu </font> <br/> <br/>
...
$cabeceras .= 'From: Hand Market <handmarketapp@gmail.com>' . "\r\n";

// Mail it
$mail->Send(mail($checkEmail, $titulo, $mensaje, $cabeceras));
